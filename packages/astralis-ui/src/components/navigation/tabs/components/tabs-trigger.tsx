  ...
  return (
    <button
      ...
      className={[
        ...
        "astralis-transition-all astralis-outline-none focus-visible:astralis-ring-2 focus-visible:astralis-ring-primary-500 focus-visible:astralis-ring-offset-2 focus-visible:astralis-rounded-md",
        disabled
        ...
        orientation === "horizontal"
          ? [
              "astralis-border-b-2",
              active
                ? "astralis-border-primary-500 astralis-text-primary-500"
          ...
          : [
              ...
              active
                ? "astralis-border-primary-500 astralis-text-primary-500 astralis-bg-primary-500/10"
