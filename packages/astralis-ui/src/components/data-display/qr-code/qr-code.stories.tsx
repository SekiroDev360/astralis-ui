  ...
  render: () => (
    <div className="astralis:flex astralis:gap-6 astralis:flex-wrap">
      ...
      <QrCode
        ...
        errorLevel="H"
        overlay={
          <div className="astralis:w-full astralis:h-full astralis:bg-gray-900 astralis:dark:bg-gray-100 astralis:flex astralis:items-center astralis:justify-center">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="astralis:text-white astralis:dark:text-gray-900"
