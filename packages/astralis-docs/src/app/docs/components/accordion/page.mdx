import { accordionProps, accordionItemProps } from "@/components/demos/accordion/accordion-props";
...
- Full keyboard support: Arrow keys rove between triggers, Home/End jump to
  the ends.
